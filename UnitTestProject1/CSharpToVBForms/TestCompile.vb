...
Namespace CSharpToVBAppCSharpToVB
    <TestClass()> Public Class TestCompile
        ...
        Private Shared Function CountFile(PathWithFileName As String, LanguageExtension As String) As Boolean
        ...
        Private Function ProcessFile(PathWithFileName As String, LanguageExtension As String) As Boolean
            ' Do not delete the next line or the parameter it is needed by other versions of this routine
            LanguageExtension = ""
        ...
        Public Sub VB_CountAll()
            ...
            Assert.Equal(8130, FilesProcessed)
        End Sub
    End Class
End Namespace
