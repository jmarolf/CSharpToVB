...
Public Class LineNumbers_For_RichTextBox : Inherits System.Windows.Forms.Control
    ...
    <System.ComponentModel.Description("Use this to set whether the LineNumbers should have leading zeros (based on the total amount of text lines).")>
    ...
    Private Sub Update_VisibleLineNumberItems()
        ...
        If zAutoSizing = True Then zAutoSizing_Size = New Size(TextRenderer.MeasureText(zLineNumbers_Format.Replace("0".ToCharArray, "W".ToCharArray), Font).Width, 0)

        If ZParent Is Nothing OrElse ZParent.Text.IsEmptyNullOrWhitespace Then
            Exit Sub
        End If
        ...
        Else
            ...
            zLineNumbers_Format = If(zLineNumbers_ShowAsHexadecimal = True, "".PadRight(zSplit.Length.ToString("X").Length, "0"), "".PadRight(zSplit.Length.ToString.Length, "0"))
        End If
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        ' --- Local Declarations
        Dim zTextToShow As String = "", zReminderToShow As String = "", zSF As New StringFormat, zTextSize As SizeF
        Dim zPen As New Pen(ForeColor), zBrush As New SolidBrush(ForeColor)
        ...
        If DesignMode = True Then
            ...
            If zReminderToShow.Length > 0 Then
                ...
                Dim zReminderRectangle As New Rectangle(Width / 2 - zTextSize.Height / 2, Height / 2 - zTextSize.Width / 2, zTextSize.Height, zTextSize.Width)
        ...
        If zLNIs.Count > 0 Then
            ...
            For zA As Integer = 0 To zLNIs.Count - 1
                ...
                If zGridLines_Show = True Then
                    ...
                    zGP_GridLines.AddRectangle(New Rectangle(-zGridLines_Thickness, zLNIs(zA).Rectangle.Y, Width + zGridLines_Thickness * 2, Height - zLNIs(0).Rectangle.Y + zGridLines_Thickness))
                ...
                If zLineNumbers_Show = True Then
                    '   TextFormatting
                    zTextToShow = If(zLineNumbers_ShowLeadingZeroes, If(zLineNumbers_ShowAsHexadecimal, zLNIs(zA).LineNumber.ToString("X"), zLNIs(zA).LineNumber.ToString(zLineNumbers_Format)), If(zLineNumbers_ShowAsHexadecimal, zLNIs(zA).LineNumber.ToString("X"), zLNIs(zA).LineNumber.ToString))
                    '   TextSizing
        ...
        Dim zP_Right As New Point(Width - Math.Ceiling(zBorderLines_Thickness / 2), Height - Math.Ceiling(zBorderLines_Thickness / 2))
