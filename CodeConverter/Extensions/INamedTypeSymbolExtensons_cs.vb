...
Namespace IVisualBasicCode.CodeConverter.Util
    ...
    Public Module INamedTypeSymbolExtensons
        ...
        <Extension>
        Private Function IsKind(ByVal symbol As ISymbol, ByVal kind As SymbolKind) As Boolean
        ...
        Private Function IsNonNestedTypeAccessible(ByVal assembly As IAssemblySymbol, ByVal declaredAccessibility As Accessibility, ByVal within As ISymbol) As Boolean
        ...
        <Extension>
        Public Function GetValidAnonymousTypeProperties(ByVal symbol As INamedTypeSymbol) As IEnumerable(Of IPropertySymbol)
        ...
        ' an assembly.
        <Extension>
        Public Function IsNamedTypeAccessible(ByVal type As INamedTypeSymbol, ByVal within As ISymbol) As Boolean
            Contract.Requires(TypeOf within Is INamedTypeSymbol OrElse TypeOf within Is IAssemblySymbol)
