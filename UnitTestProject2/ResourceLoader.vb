...
Namespace TestResources
    Friend Module ResourceLoader
        ...
        Private Function GetResourceBlob(ByVal name As String) As Byte()
        ...
        Public Function GetOrCreateResource(ByRef resource() As Byte, ByVal name As String) As Byte()
        ...
        Public Function GetOrCreateResource(ByRef resource As String, ByVal name As String) As String
            If resource Is Nothing Then
                Using stream As Stream = GetResourceStream(name)
