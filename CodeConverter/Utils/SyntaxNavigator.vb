...
Namespace Microsoft.CodeAnalysis
    ...
    Friend NotInheritable Class SyntaxNavigator
        ...
        Private Shared Function Matches(ByVal predicate As Func(Of SyntaxToken, Boolean), ByVal token As SyntaxToken) As Boolean
            Return predicate Is Nothing OrElse ReferenceEquals(predicate, Function(t As SyntaxToken) True) OrElse predicate(token)
        End Function

        Private Function GetFirstToken(ByVal triviaList As SyntaxTriviaList, ByVal predicate As Func(Of SyntaxToken, Boolean), ByVal stepInto As Func(Of SyntaxTrivia, Boolean)) As SyntaxToken
        ...
        Private Function GetFirstToken(ByVal token As SyntaxToken, ByVal predicate As Func(Of SyntaxToken, Boolean), ByVal stepInto As Func(Of SyntaxTrivia, Boolean)) As SyntaxToken
        ...
        Private Function GetFirstToken(ByVal current As SyntaxNode, ByVal predicate As Func(Of SyntaxToken, Boolean), ByVal stepInto As Func(Of SyntaxTrivia, Boolean)) As SyntaxToken
        ...
        Private Function GetNextToken(ByVal current As SyntaxTrivia, ByVal list As SyntaxTriviaList, ByVal predicate As Func(Of SyntaxToken, Boolean), ByVal stepInto As Func(Of SyntaxTrivia, Boolean), ByRef returnNext As Boolean) As SyntaxToken
        ...
        Friend Function GetNextToken(ByVal current As SyntaxToken, ByVal predicate As Func(Of SyntaxToken, Boolean), ByVal stepInto As Func(Of SyntaxTrivia, Boolean)) As SyntaxToken
            Return GetNextToken(current, predicate, stepInto IsNot Nothing, stepInto)
        End Function

        Friend Function GetNextToken(ByVal current As SyntaxTrivia, ByVal predicate As Func(Of SyntaxToken, Boolean), ByVal stepInto As Func(Of SyntaxTrivia, Boolean)) As SyntaxToken
        ...
        Friend Function GetNextToken(ByVal node As SyntaxNode, ByVal predicate As Func(Of SyntaxToken, Boolean), ByVal stepInto As Func(Of SyntaxTrivia, Boolean)) As SyntaxToken
        ...
        Friend Function GetNextToken(ByVal current As SyntaxToken, ByVal predicate As Func(Of SyntaxToken, Boolean), ByVal searchInsideCurrentTokenTrailingTrivia As Boolean, ByVal stepInto As Func(Of SyntaxTrivia, Boolean)) As SyntaxToken
